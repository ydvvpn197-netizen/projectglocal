-- ============================================================================
-- ROW LEVEL SECURITY POLICIES - TheGlocal Project
-- ============================================================================
...
-- ============================================================================
-- REFERRAL PROGRAM TABLE POLICIES
-- ============================================================================

-- Users can view their own referral program data
CREATE POLICY "Users can view own referral program data" ON public.referral_program
  FOR SELECT USING (auth.uid() = referrer_id OR auth.uid() = referred_id);

-- Users can create referral program entries
CREATE POLICY "Users can create referral program entries" ON public.referral_program
  FOR INSERT WITH CHECK (public.is_authenticated() AND auth.uid() = referrer_id);

-- Users can update their own referral program entries
CREATE POLICY "Users can update own referral program entries" ON public.referral_program
  FOR UPDATE USING (auth.uid() = referrer_id OR auth.uid() = referred_id);

-- System can manage referral program
CREATE POLICY "System can manage referral program" ON public.referral_program
  FOR ALL USING (true);
...
-- Users can view marketing campaigns
