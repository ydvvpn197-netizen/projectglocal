-- ============================================================================
-- CORE DATABASE SCHEMA - TheGlocal Project
-- ============================================================================
-- This migration creates the foundational database schema including:
-- - Core enums and types
-- - Essential tables for the platform
...
CREATE TABLE public.profiles (
  ...
  total_referral_rewards DECIMAL(10,2) DEFAULT 0
);
...
CREATE INDEX idx_security_audit_resource ON public.security_audit(resource);
CREATE INDEX idx_security_audit_created_at ON public.security_audit(created_at);
CREATE INDEX idx_security_audit_success ON public.security_audit(success);

-- Referral system indexes
CREATE INDEX idx_referral_program_referrer_id ON public.referral_program(referrer_id);
CREATE INDEX idx_referral_program_referred_id ON public.referral_program(referred_id);
CREATE INDEX idx_referral_program_code ON public.referral_program(referral_code);
CREATE INDEX idx_referral_program_status ON public.referral_program(status);
